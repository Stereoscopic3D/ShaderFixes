...
static const float font_scale = 1.6;
...
//Define [Constants]
#define help_enable IniParams[2].y
...
//***************************************************************
	...
	cur_pos = float2(-0.98, 0 - (start_pos % max_y) * char_height);
		
//***************************************************************

//Game Help - Key Presets:
//
//F1: This screen
//P: Crosshair Depth
//L: Target Icons Depth
	
	if (help_enable) {

	//idx == i++ defines each line
			if (idx == i++) {
				emit_char('G', ostream);
				emit_char('a', ostream);
				emit_char('m', ostream);
